  ...
  return (
    <Link
      ...
      className={cn(
        ...
        isActive
          ? "bg-white/10 text-white border-l-4 border-erp-blue pl-[8px]"
          : "hover:bg-slate-900",
      )}
    >
    ...
    <div className="flex h-screen overflow-hidden">
      <aside className="w-60 min-w-[240px] bg-slate-950 text-slate-300 flex flex-col border-r border-slate-800 shrink-0 overflow-hidden">
        <div className="p-4 flex items-center gap-3 border-b border-slate-800">
          ...
          <div>
            <h1 className="text-white text-base font-bold leading-none font-condensed">
              NEXUS
            </h1>
        ...
        <div className="p-4 border-t border-slate-800 bg-slate-900/50">
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              <p className="text-[11px] font-bold text-slate-100 uppercase truncate">
                {user?.nome ?? "Usuário"}
              </p>
            </div>
            <button
