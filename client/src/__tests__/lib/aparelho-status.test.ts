...
describe('STATUS_CONFIG_APARELHO', () => {
  ...
  STATUS_ESPERADOS.forEach((status) => {
    describe(status, () => {
      it('tem label', () => expect(STATUS_CONFIG_APARELHO[status].label).toBeTruthy())
      it('tem color', () => expect(STATUS_CONFIG_APARELHO[status].color).toBeTruthy())
      it('tem bgColor', () => expect(STATUS_CONFIG_APARELHO[status].bgColor).toBeTruthy())
      it('tem borderColor', () => expect(STATUS_CONFIG_APARELHO[status].borderColor).toBeTruthy())
      it('tem icon', () => expect(STATUS_CONFIG_APARELHO[status].icon).toBeTruthy())
      it('tem dotColor', () => expect(STATUS_CONFIG_APARELHO[status].dotColor).toBeTruthy())
    })
  })
