...
describe('formatarMoeda', () => {
  ...
  it('formata valor simples', () => expect(formatarMoeda(1)).toBe('R$\u00a01,00'))
  it('formata decimais', () => expect(formatarMoeda(1.5)).toBe('R$\u00a01,50'))
  it('formata valor negativo', () => expect(formatarMoeda(-10)).toMatch(/-/))
  it('formata valor grande', () => expect(formatarMoeda(1234.56)).toBe('R$\u00a01.234,56'))
})

describe('formatarMoedaDeCentavos', () => {
  it('0 centavos → R$ 0,00', () => expect(formatarMoedaDeCentavos(0)).toBe('R$\u00a00,00'))
  it('100 centavos → R$ 1,00', () => expect(formatarMoedaDeCentavos(100)).toBe('R$\u00a01,00'))
  it('1050 centavos → R$ 10,50', () => expect(formatarMoedaDeCentavos(1050)).toBe('R$\u00a010,50'))
})
...
describe('formatarTelefone', () => {
  ...
  it('1 dígito → com parêntese', () => expect(formatarTelefone('1')).toBe('(1'))
  it('2 dígitos → parênteses', () => expect(formatarTelefone('11')).toBe('(11'))
  it('fixo (10 dígitos)', () => expect(formatarTelefone('1133334444')).toBe('(11) 3333-4444'))
  it('celular (11 dígitos)', () => expect(formatarTelefone('11999998888')).toBe('(11) 99999-8888'))
  it('ignora não-dígitos', () => expect(formatarTelefone('(11) 99999-8888')).toBe('(11) 99999-8888'))
})

describe('formatarCEP', () => {
  it('menos de 5 dígitos → só dígitos', () => expect(formatarCEP('1234')).toBe('1234'))
  it('8 dígitos → formatado', () => expect(formatarCEP('01310100')).toBe('01310-100'))
  it('com hífen já formatado → idempotente', () => expect(formatarCEP('01310-100')).toBe('01310-100'))
})

describe('formatarPlaca', () => {
  it('menos de 3 chars → sem hífen', () => expect(formatarPlaca('AB')).toBe('AB'))
  it('placa antiga 7 chars', () => expect(formatarPlaca('ABC1234')).toBe('ABC-1234'))
  it('placa mercosul', () => expect(formatarPlaca('ABC1D23')).toBe('ABC-1D23'))
  it('remove caracteres especiais e aplica uppercase', () => expect(formatarPlaca('abc-1234')).toBe('ABC-1234'))
  it('trunca em 7 chars', () => expect(formatarPlaca('ABC12345')).toBe('ABC-1234'))
})

describe('placaApenasAlfanumericos', () => {
  it('remove hífen', () => expect(placaApenasAlfanumericos('ABC-1234')).toBe('ABC1234'))
  it('converte para uppercase', () => expect(placaApenasAlfanumericos('abc1234')).toBe('ABC1234'))
  it('remove espaços', () => expect(placaApenasAlfanumericos('ABC 1234')).toBe('ABC1234'))
})
...
describe('formatarCNPJ', () => {
  ...
  it('12 dígitos', () => expect(formatarCNPJ('123456780001')).toBe('12.345.678/0001'))
  it('14 dígitos completo', () => expect(formatarCNPJ('12345678000195')).toBe('12.345.678/0001-95'))
})
...
describe('formatarCPF', () => {
  ...
  it('11 dígitos completo', () => expect(formatarCPF('12345678901')).toBe('123.456.789-01'))
})

describe('formatarCPFCNPJ', () => {
  it('11 dígitos → formata como CPF', () => expect(formatarCPFCNPJ('12345678901')).toBe('123.456.789-01'))
  it('14 dígitos → formata como CNPJ', () => expect(formatarCPFCNPJ('12345678000195')).toBe('12.345.678/0001-95'))
})

describe('parseDataLocal', () => {
  it('string vazia → epoch', () => expect(parseDataLocal('')).toEqual(new Date(0)))
...
describe('formatarDataHora', () => {
  ...
  it('data válida → string com ano', () => expect(formatarDataHora('2024-04-18T10:00:00')).toMatch(/2024/))
})
...
describe('formatarDuracao', () => {
  ...
  it('só horas → "2h"', () => {
    expect(formatarDuracao('2024-01-01T08:00:00', '2024-01-01T10:00:00')).toBe('2h')
  })
  it('1 dia → "1 dia"', () => {
  ...
  it('dias e horas → "1 dia e 2h"', () => {
    expect(formatarDuracao('2024-01-01T08:00:00', '2024-01-02T10:00:00')).toBe('1 dia e 2h')
  })
})

describe('formatarTempoMinutos', () => {
  it('42 minutos → "42 min"', () => expect(formatarTempoMinutos(42)).toBe('42 min'))
  it('60 minutos → "1h"', () => expect(formatarTempoMinutos(60)).toBe('1h'))
  it('90 minutos → "1h 30min"', () => expect(formatarTempoMinutos(90)).toBe('1h 30min'))
  it('0 minutos → "0 min"', () => expect(formatarTempoMinutos(0)).toBe('0 min'))
})

describe('formatId', () => {
  it('id 1 → 9 dígitos com zeros', () => expect(formatId(1)).toBe('000000001'))
  it('id 123456789 → sem zeros', () => expect(formatId(123456789)).toBe('123456789'))
