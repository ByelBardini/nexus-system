  ...
  >({
    ...
    queryFn: () =>
      operadoraIdParaMarca
        ? api(
            `/equipamentos/marcas-simcard?operadoraId=${operadoraIdParaMarca}`,
          )
    ...
    <div className="-m-4 flex min-h-[100dvh] flex-col bg-slate-100">
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="col-span-2">
                  <Label className="text-[10px] font-bold text-slate-500 uppercase mb-1.5 block">
                    {watchTipo === "RASTREADOR" ? "IMEI" : "ICCID"} / Número de
                  ...
                  {idJaExiste && (
                    <p className="text-[10px] text-red-600 mt-1 font-bold uppercase">
                      Atenção: Este{" "}
                      {watchTipo === "RASTREADOR" ? "IMEI" : "ICCID"} já consta
                      no sistema
                      {idJaExiste.lote &&
                ...
                <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-sm">
                  <div className="flex gap-3">
                    ...
                    <p className="text-[11px] text-amber-800 font-medium">
                      O {watchTipo === "RASTREADOR" ? "IMEI" : "ICCID"}{" "}
                      informado já possui um registro ativo. Registrar novamente
                      criará um histórico de duplicidade.
                    </p>
                  </div>
                </div>
              )}
      ...
      <div className="z-10 flex h-20 shrink-0 items-center justify-end gap-4 border-t border-slate-200 bg-white px-8">
        ...
        <Button
          ...
          disabled={
            !canCreate || !podeSalvar || createAparelhoMutation.isPending
          }
