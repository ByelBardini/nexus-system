...
import type { StatusPedidoKey } from "./pedidos-rastreador-kanban";

export type TipoDestinoPedido = "TECNICO" | "CLIENTE" | "MISTO";

export type { StatusPedidoRastreador } from "./pedidos-rastreador-api-enums";
export type { StatusPedidoKey } from "./pedidos-rastreador-kanban";
...
export { mapPedidoToView } from "./map-pedido-rastreador-to-view";
