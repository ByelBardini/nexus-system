...
export function SidePanel({
  ...
  const { data: kitDetalhes, isLoading: carregandoDetalhes } = useQuery({
    ...
    queryFn: () =>
      api<KitComAparelhos>(`/aparelhos/pareamento/kits/${detalhesKitId}`),
          ...
          >
            <div>
              ...
              <div className="grid grid-cols-3 gap-2">
                {[
                  {
                    value: "TRANSPORTADORA" as const,
                    label: "Transportadora",
                    icon: "local_shipping",
                  },
                  {
                    value: "CORREIOS" as const,
                    label: "Correios",
                    icon: "mail",
                  },
                  {
                    value: "EM_MAOS" as const,
                    label: "Em Mãos",
                    icon: "handshake",
                  },
                ].map((opt) => (
                ...
                {tipoDespacho === "TRANSPORTADORA" && (
                  <div>
                    ...
                    <Input
                      ...
                      onBlur={(e) =>
                        onTransportadoraChange(e.target.value.trim())
                      }
